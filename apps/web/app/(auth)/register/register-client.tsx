  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h1 className="text-2xl md:text-3xl font-serif font-bold text-foreground tracking-tight">Create your account</h1>
        <p className="mt-2 text-[15px] text-muted-foreground">
          Your personal, intelligent photo archive
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          type="button"
          variant="outline"
          className="h-12 border-border bg-background hover:bg-muted text-foreground font-medium text-[14px] flex items-center justify-center gap-2.5 rounded-xl transition-colors shadow-sm"

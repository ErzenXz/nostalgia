...
export default function SettingsPage() {
  const { aiOptIn, isLoading, setAiOptIn } = useAiOptIn();
        ...
        <section className="rounded-xl border border-border bg-card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">
                Security settings for encryption and sessions will appear here.
              </p>
            </div>
          </div>
        </section>
...
function FeatureCard({
  ...
  return (
    ...
    >
      <Icon className={cn("h-4 w-4 mt-0.5 shrink-0", active ? iconColor : "text-muted-foreground")} />
      <div>

    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          type="button"
          variant="outline"
          className="h-11 border-border bg-card hover:bg-muted text-foreground font-medium text-[13px] flex items-center justify-center gap-2.5 rounded-lg transition-colors"
        ...
        <Button
          ...
          disabled={isLoading}
        >
          <Github className="h-4.5 w-4.5 shrink-0" />
          GitHub
        </Button>
      </div>
